...
(function($) {
	...
	jQuery.fn.MyDigitClock.defaults = {
		...
		fontWeight: '400',
		background: '',
		timeFormat: '<span class="time-bg">{HH}</span><span id="ch1"><span class="stime">时</span></span><span class="time-bg">{MM}</span><span id="ch2"><span class="stime">分</span></span><span class="time-bg">{SS}</span><span class="stime">秒</span>',
